...
async function searchKickCategories(query: string): Promise<CategorySearchResult[]> {
...
export async function handleSearchCategories(url: URL): Promise<SearchCategoriesResponse> {
