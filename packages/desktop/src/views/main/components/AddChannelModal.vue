...
const placeholder = computed(() => {
  if (platform.value === "twitch") return "Twitch channel name";
  if (platform.value === "kick") return "Kick channel name";
  return "YouTube channel handle or ID";
});

function selectPlatform(p: "twitch" | "kick" | "youtube") {
  if (p === "youtube" && !props.youtubeAuthenticated) return;
  platform.value = p;
}
      ...
      <div class="modal" @keydown="onKeydown">
        ...
        <div class="platform-row">
          ...
          >
            ...
            YouTube
            <svg v-if="!youtubeAuthenticated" class="lock-icon" width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
